        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QrTokenHash = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OrganizationMembers_Role", "[Role] IN (1, 2, 3)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Events_Status", "[Status] IN (0, 1, 2, 3, 4, 5, 6)");
                    table.CheckConstraint("CK_Events_TimeRange", "[EndsAt] > [StartsAt]");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Events_StoredFiles_CoverImageFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_EventApprovalHistories_FromStatus", "[FromStatus] IN (0, 1, 2, 3, 4, 5, 6)");
                    table.CheckConstraint("CK_EventApprovalHistories_ToStatus", "[ToStatus] IN (0, 1, 2, 3, 4, 5, 6)");
                    table.ForeignKey(
                        name: "FK_EventApprovalHistories_AspNetUsers_ActionByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_EventDocuments_DocumentType", "[DocumentType] IN (1, 2)");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EventDocuments_StoredFiles_StoredFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventStaffAssignments_AspNetUsers_AssignedByUserId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EventStaffAssignments_OrganizationMembers_OrganizationMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Orders_ExpiresAt", "[ExpiresAt] > [CreatedAt]");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaleStartsAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    SaleEndsAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TicketTypes_MaxQuantityPerOrder", "[MaxQuantityPerOrder] > 0");
                    table.CheckConstraint("CK_TicketTypes_Price", "[Price] >= 0");
                    table.CheckConstraint("CK_TicketTypes_Quantities", "[TotalQuantity] >= 0 AND [ReservedQuantity] >= 0 AND [SoldQuantity] >= 0 AND [SoldQuantity] <= [TotalQuantity] AND [ReservedQuantity] <= [TotalQuantity] - [SoldQuantity]");
                    table.CheckConstraint("CK_TicketTypes_SaleTimeRange", "[SaleEndsAt] > [SaleStartsAt]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventStaffAssignmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CheckIns_EventStaffAssignments_EventStaffAssignmentId",
                        column: x => x.EventStaffAssignmentId,
                        principalTable: "EventStaffAssignments",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderTransactionId = table.Column<string>(type: "varchar(150)", unicode: false, maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketTypeName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckIns_EventStaffAssignmentId_CheckedInAt",
                table: "CheckIns",
                columns: new[] { "EventStaffAssignmentId", "CheckedInAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventApprovalHistories_ActionByUserId",
                table: "EventApprovalHistories",
                column: "ActionByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_EventApprovalHistories_EventId_CreatedAt",
                table: "EventApprovalHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventDocuments_EventId_StoredFileId",
                table: "EventDocuments",
                columns: new[] { "EventId", "StoredFileId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EventDocuments_StoredFileId",
                table: "EventDocuments",
                column: "StoredFileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_CoverImageFileId",
                table: "Events",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventStaffAssignments_AssignedByUserId",
                table: "EventStaffAssignments",
                column: "AssignedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_EventStaffAssignments_EventId_OrganizationMemberId",
                table: "EventStaffAssignments",
                columns: new[] { "EventId", "OrganizationMemberId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EventStaffAssignments_OrganizationMemberId",
                table: "EventStaffAssignments",
